...
lean_lib AbstractCryptographySelectedSurfaceTests where
  globs := #[.one `Tests.AbstractCryptographySelectedSurfaceTests]
...
lean_lib AbstractCryptographyProofAutomationTests where
  globs := #[.one `Tests.AbstractCryptographyProofAutomationTests]
...
lean_lib AbstractCryptographyCalcChainTests where
  globs := #[.one `Tests.AbstractCryptographyCalcChainTests]
...
lean_lib AbstractCryptographyContextRestrictedTests where
  globs := #[.one `Tests.AbstractCryptographyContextRestrictedTests]
...
lean_lib AbstractCryptographyIndexedRelaxationTests where
  globs := #[.one `Tests.AbstractCryptographyIndexedRelaxationTests]
...
lean_lib AbstractCryptographyControlledNaturalLanguageTests where
  globs := #[.one `Tests.AbstractCryptographyControlledNaturalLanguageTests]
...
lean_lib AbstractCryptographyConstructionWorkflowTests where
  globs := #[.one `Tests.AbstractCryptographyConstructionWorkflowTests]
...
lean_lib ConstructiveCryptographySelectedSurfaceTests where
  globs := #[.one `Tests.ConstructiveCryptographySelectedSurfaceTests]
