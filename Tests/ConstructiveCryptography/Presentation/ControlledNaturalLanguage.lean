...
/-!
# Typed Constructive Cryptography controlled-language tests
...
namespace ConstructiveCryptography.Categorical.ResourceAlgebra.Tests.ControlledNaturalLanguage
...
example {A B : C} {left right : A ⟶ B}
    {source : Specification Phi B} {target : Specification Phi A}
    {error : ENNReal} (converterEquation : left = right)
...
/-- trace: [CryptoControlledNaturalLanguage.sentence] cc.construction.follows_from -/
#guard_msgs in
...
/-- trace: [CryptoControlledNaturalLanguage.sentence] cc.equality.follows_from -/
#guard_msgs in
set_option trace.CryptoControlledNaturalLanguage.sentence true in
example {A B : C} {left right : A ⟶ B}
...
/-- trace: [CryptoControlledNaturalLanguage.sentence] cc.construction.replace_converter -/
#guard_msgs in
set_option trace.CryptoControlledNaturalLanguage.sentence true in
example {A B : C} {left right : A ⟶ B}
    {source : Specification Phi B} {target : Specification Phi A}
...
/-- trace: [CryptoControlledNaturalLanguage.sentence] cc.construction.by_composition -/
#guard_msgs in
set_option trace.CryptoControlledNaturalLanguage.sentence true in
example {A B D : C} {first : A ⟶ B} {second : B ⟶ D}
    {source : Specification Phi D} {middle : Specification Phi B}
...
/-- trace: [CryptoControlledNaturalLanguage.sentence] cc.argument.named_fact -/
#guard_msgs in
set_option trace.CryptoControlledNaturalLanguage.sentence true in
...
set_option trace.CryptoControlledNaturalLanguage.sentence true in
example (proposition : Prop) (proof : proposition) : proposition := by
  We have intermediateFact : proposition from proof
  exact intermediateFact

/-- trace: [CryptoControlledNaturalLanguage.sentence] cc.construction.from_simulator -/
#guard_msgs in
set_option trace.CryptoControlledNaturalLanguage.sentence true in
example {A B : C} (converter : A ⟶ B) (simulator : A ⟶ A)
    (converters : EndoFamily (Opposite.op A))
...
/-- trace: [CryptoControlledNaturalLanguage.sentence] cc.construction.right_parallel_context -/
#guard_msgs in
set_option trace.CryptoControlledNaturalLanguage.sentence true in
example {A A' B : C} {converter : A ⟶ A'}
    {source : Specification Phi A'} {target : Specification Phi A}
...
/-- trace: [CryptoControlledNaturalLanguage.sentence] cc.construction.left_parallel_context -/
#guard_msgs in
set_option trace.CryptoControlledNaturalLanguage.sentence true in
example {A B B' : C} {converter : B ⟶ B'}
    {source : Specification Phi B'} {target : Specification Phi B}
...
example (proof : True) : True := by
  We have contradiction : False by
    exact proof

/-- error: Type mismatch -/
#guard_msgs (substring := true) in
example (proof : True) : True := by
  We have contradiction : False from proof
...
/-- error: expected `converter` in this controlled-language sentence -/
#guard_msgs (substring := true) in
example (construction equation : True) : True := by
  Replacing the adapter in construction using equation,
    we obtain the required construction

/-- error: expected `have` in this controlled-language sentence -/
#guard_msgs (substring := true) in
example (proposition : Prop) (proof : proposition) : proposition := by
  We know intermediateFact : proposition from proof

end ConstructiveCryptography.Categorical.ResourceAlgebra.Tests.ControlledNaturalLanguage
