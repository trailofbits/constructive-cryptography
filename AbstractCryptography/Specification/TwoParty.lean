...
Split out of `AbstractCryptography.Specification.Filtered` on 2026-08-17.
Definition 20, equation (5)'s four-pattern abstraction, and Theorem 4 are
MauRen11 Appendix C and have no MauRen16 counterpart, so they sit behind the
fence; `filteredAt` and its local-simulator construction stay on the MR16
track in `Specification.Filtered`, where LiuMau20 §§2.4-2.5 and MauRen16
Definition 2 ground them.
-/
